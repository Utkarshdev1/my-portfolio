...
const projects = [
  {
    ...
    description:
      "Spent 3+ years building the banking features millions of people use daily. Credit card payments, account opening, tax flows, login with biometrics. Owned the security layer end to end and built a shared component library the whole team adopted.",
  ...
  },
  {
    ...
    description:
      "Built the entire app from scratch as the sole senior engineer. Job search, real-time 1:1 and group chat, a live hiring pipeline, and a college community for students, alumni and recruiters. Nine months, one app, shipped and live.",
  ...
  },
  {
    ...
    description:
      "First two years of my career, working on enterprise mobile apps for clients where quality and stability weren't optional. Max Life Insurance was the main one. Spent a lot of time on performance, wrote cleaner integrations than I inherited, and started a code review process that hadn't existed before.",
  ...
  },
  {
    ...
    description:
      "Building an agriculture business focused on seeds, distribution, and modern operations. Applying the same systems thinking from software to a real-world supply chain. Long game, big vision.",
        ...
        <div className="space-y-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="rounded-[32px] border border-white/10 bg-white/5 backdrop-blur-xl p-10 hover:border-green-500/20 transition duration-500"
            >
              <div className="grid lg:grid-cols-2 gap-12 items-start">

                {/* LEFT */}
                <div>
                  <p className="text-green-500 text-sm font-medium uppercase tracking-widest mb-4">
                    {project.label}
                  </p>
