...
const experiences = [
...

  {
    ...
    description:
      "This was a build-from-scratch job. No existing codebase, no handover docs, just a product idea and a small team. I set up the architecture, made the stack decisions, and shipped the whole thing. Real-time chat, job tracking, a college community feature. Nine months, one app, shipped.",
    achievements: [
...
export default function Experience() {
  return (
    <section
      id="experience"
      className="relative py-32 bg-[#050816] text-white px-6"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          transition={{ duration: 0.7 }}
          viewport={{ once: true }}
          className="mb-20 flex flex-wrap items-center gap-6 rounded-2xl border border-white/10 bg-white/5 px-8 py-6"
        >
